...
/* Definitions for printpio */
osThreadId_t printpioHandle;
uint32_t printpioBuffer[ 128 ];
osStaticThreadDef_t printpioControlBlock;
const osThreadAttr_t printpio_attributes = {
  .name = "printpio",
  .cb_mem = &printpioControlBlock,
  .cb_size = sizeof(printpioControlBlock),
  .stack_mem = &printpioBuffer[0],
  .stack_size = sizeof(printpioBuffer),
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for piosemaphore */
osSemaphoreId_t piosemaphoreHandle;
osStaticSemaphoreDef_t piosemaphoreControlBlock;
const osSemaphoreAttr_t piosemaphore_attributes = {
  .name = "piosemaphore",
  .cb_mem = &piosemaphoreControlBlock,
  .cb_size = sizeof(piosemaphoreControlBlock),
};
/* USER CODE BEGIN PV */
...
void HAL_ADC_ConvHalfCpltCallback(ADC_HandleTypeDef *hadc)
{
	...
	//osSemaphoreRelease(piosemaphoreHandle);
...
/**
* @brief Function implementing the printpio thread.
* @param argument: Not used
* @retval None
*/
...
void StartTask02(void *argument)
{
  ...
  /* Infinite loop */
	...
	while(1){
		...
		// Determine which half of the buffer to print based on 'half' variable
