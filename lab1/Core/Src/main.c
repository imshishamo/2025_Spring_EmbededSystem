...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LED2_PIN         GPIO_PIN_14       // LED2 對應的腳位
#define LED2_GPIO_PORT   GPIOB             // LED2 連接的 GPIO Port

#define BUTTON_PIN       GPIO_PIN_13       // 按鈕對應的腳位
#define BUTTON_GPIO_PORT GPIOC             // 按鈕連接的 GPIO Port
/* USER CODE END PD */
...
/* Private variables ---------------------------------------------------------*/
osSemaphoreId_t buttonSemaphoreHandle;  // 按鈕中斷二元信號量
osSemaphoreId_t timerSemaphoreHandle;   // 定時器中斷二元信號量
osMutexId_t ledMutexHandle;             // 用來保護 LED2 的互斥鎖
